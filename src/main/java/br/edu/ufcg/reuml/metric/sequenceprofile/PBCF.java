 ...
 */
public class PBCF implements Measurable {

    public static final String NAME = "Presence of combined fragments of type break";
    private static final String XPATH_QUERY = "count(//fragment[@*=\"uml:CombinedFragment\"][@interactionOperator=\"break\"])";
