 ...
 */
public class PIgCF implements Measurable {

    public static final String NAME = "Presence of combined fragments of type ignore";
    private static final String XPATH_QUERY = "count(//fragment[@*=\"uml:ConsiderIgnoreFragment\"][@interactionOperator=\"ignore\"])";
