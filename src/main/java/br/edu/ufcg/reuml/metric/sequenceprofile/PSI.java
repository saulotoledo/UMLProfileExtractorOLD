 ...
 */
public class PSI implements Measurable {

    public static final String NAME = "Presence of sequence diagrams with invariant state";
    private static final String XPATH_QUERY = "count(//fragment[@*=\"uml:StateInvariant\"])";
