 ...
 */
public class PCM implements Measurable {

    public static final String NAME = "Presence of creation messages";
    private static final String XPATH_QUERY = "count(//message[@*=\"uml:Message\"][@messageSort=\"createMessage\"])";
