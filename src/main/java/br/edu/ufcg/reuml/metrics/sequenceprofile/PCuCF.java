 ...
 */
public class PCuCF implements Measurable {

    public static final String NAME = "Presence of combined fragments of type concurrent";
    private static final String XPATH_QUERY = "count(//fragment[@*=\"uml:CombinedFragment\"][@interactionOperator=\"par\"])";
